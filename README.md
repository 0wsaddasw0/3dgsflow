...
今天可在浏览器完成**编辑**与**网页展览导出**；拍摄设备与本地训练工具将陆续接入同一工作流。支持 **PLY / SPLAT / SPZ**，无需注册，数据不出本机。
...
| **04 交付** | **部分可用** | 网页展览已可用；VR 与 GIS 场景持续接入 | 见下方三种交付 |
...
| 方向 | 状态 | 说明 | 入口 |
|------|------|------|------|
| **物品展览** | **现已支持** | 静态网页包，适合展品、商品与官网嵌入 | [去编辑并导出](https://3dgsflow.com/editor) |
...
所有解析与处理在浏览器本地完成，不上传用户模型文件。建议使用**电脑端**浏览器打开工作台。
...
| 页面 | 链接 |
|------|------|
| 指南中心 | [https://3dgsflow.com/guide](https://3dgsflow.com/guide) |
| 什么是高斯溅射（3DGS） | […/guide/gaussian-splatting](https://3dgsflow.com/guide/gaussian-splatting) |
| 在线 3DGS 编辑器能做什么 | […/guide/editor](https://3dgsflow.com/guide/editor) |
| PLY / SPLAT / SPZ 格式说明 | […/guide/formats](https://3dgsflow.com/guide/formats) |
| 如何导出可部署的 3DGS 网页 | […/guide/export](https://3dgsflow.com/guide/export) |

---

## 关键词

`高斯溅射` · `高斯泼溅` · `3DGS` · `3D Gaussian Splatting` · `3DGS 工作流` · `Gaussian Splatting editor` · `3DGS 编辑器` · `3DGS 训练` · `PLY` · `SPLAT` · `SPZ` · `点云清洗` · `3DGS 导出网页` · `物品展览` · `3DGSFlow`
...
| 节点 | 说明 |
|------|------|
| **即将上线** | 物品展览专用导出页、导出四向选型（展览 / VR / GIS）、官网指南页与版本历史 |
